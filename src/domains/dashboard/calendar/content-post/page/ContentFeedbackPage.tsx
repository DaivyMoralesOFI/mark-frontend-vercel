...
import { CreatePostModal } from "@/modules/creation-studio/components/CreatePostModal";
...
export default function ContentFeedbackPage() {
  ...
  return (
    <>
      ...
      <PageOutletLayout<"with-actions"> pageTitle="Content Feedback" actions={pageActions}>
        {viewMode !== "list" ? (
