...
import { firebaseQueryOptions } from "@/core/config/query-client";
...
export function useFirebaseQuery<TData = unknown, TError = Error>(
  options: UseQueryOptions<TData, TError> & {
    type?: "studio" | "analysis" | "brands";
  },
) {
  const { type = "analysis", ...queryOptions } = options;
